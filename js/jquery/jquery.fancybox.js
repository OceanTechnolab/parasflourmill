...
;(function($) {
  ...
  var isChrome = /chrome/.test( navigator.userAgent.toLowerCase() );
	$.fn.fancybox = function(settings) {
		...
		function _finish() {
			...
			if (opts.itemArray[ opts.itemCurrent ].title !== undefined && opts.itemArray[ opts.itemCurrent ].title.length > 0) {
				...
				$("#fancy_title_left").css('background','transparent url(js/jquery/fancy_title_left.png) repeat-x');
				$("#fancy_title_main").css('background','transparent url(js/jquery/fancy_title_main.png) repeat-x');
				$("#fancy_title_right").css('background','transparent url(js/jquery/fancy_title_right.png) repeat-x');	
	...
	$.fn.fancybox.build = function() {
		...
		$('<table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td class="fancy_title" id="fancy_title_left" ></td><td class="fancy_title" id="fancy_title_main" align="center"><div id="fancy_text_main" align="center"></div></td><td class="fancy_title" id="fancy_title_right"></td></tr></table>').appendTo('#fancy_title');
